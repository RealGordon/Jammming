...
export class App extends React.Component {
  ...
  removeTrack(track) {
    this.setState({
      playlistTracks: this.state.playlistTracks.filter(v => v.id !== track.id)
    });
  }
  ...
  render() {
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h1", null, "Ja", /*#__PURE__*/React.createElement("span", {
      className: "highlight"
    }, "mmm"), "ing"), /*#__PURE__*/React.createElement(Avatar, null), /*#__PURE__*/React.createElement("div", {
      className: "App"
